...
const ManageBooks = () => {
  ...
  useEffect(() => {
    fetch("https://deploy-theta-gilt.vercel.app/all-books")
      .then((res) => res.json())
  ...
  return (
    <div className="px-4 my-12">
      ...
      <Table className="lg:w-[1180px]">
        ...
        {
          allBooks.map((book,index) => <Table.Body className="divide-y" key={book._id}>     <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
